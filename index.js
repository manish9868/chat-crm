...
async function getTemplate() {
    let response = await fetch(`https://api.wolfeocrm.com/v1/setting/2/template/52`, {
        ...
        headers: {
            ...
            'authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJMVENCV1M4RkRVTkdTMDNUIiwiaXNzIjoiaHR0cHM6Ly9hcGkuaWxvZ2dlcnouY29tL2FwaS92MS9sb2dpbiIsImlhdCI6MTY3NzY1OTU5NCwiZXhwIjoxNjc3NjYzMTk0LCJuYmYiOjE2Nzc2NTk1OTQsImp0aSI6IkxUQ0JXUzhGRFVOR1MwM1QxNjc3NjU5NTk0In0.yJBDfyDRneDNF8-YbbksdJJpqyoWXuzE8a9a6BFs1j8'
        }
    }).then(async (res) => {
        data = await res.json();
    })
